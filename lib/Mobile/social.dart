...
class MobileSocial extends StatefulWidget {
  const MobileSocial({super.key});

  @override
  State<MobileSocial> createState() => _MobileSocialState();
}

class _MobileSocialState extends State<MobileSocial> {
